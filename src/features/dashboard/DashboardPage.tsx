...
export const DashboardPage: React.FC = () => {
    ...
    const [statusFilter, setStatusFilter] = useState<
        "all" | "compliant" | "expiring" | "non_compliant"
    >("all");
    ...
    useEffect(() => {
        ...
        const fetchDashboard = async () => {
            ...
            try {
                ...
                setError(
                    err.message || "Failed to connect to backend dashboard.",
                );
            } finally {
                setLoading(false);
            }
        ...
        return (
            <div className="p-8 max-w-4xl mx-auto text-center space-y-4">
                ...
                <h2 className="font-heading font-bold text-2xl text-[#0b1c30]">
                    Super Admin Central Console
                </h2>
                <p className="text-sm text-[#57605f] max-w-md mx-auto">
                    You are authenticated as a Platform Super Administrator.
                    Super admins provision tenant organizations and manage
                    system-wide audit controls.
                </p>
                <div className="pt-4">
                    <button
    ...
    const compliantPercent =
        totals.clinicians > 0
            ? Math.round((totals.compliant / totals.clinicians) * 100)
            : 100;
    ...
    const filteredClinicians = cliniciansList.filter((c) => {
        ...
        if (statusFilter === "compliant")
            matchesFilter = isCompliant && !isExpiring;
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-[#57605f] mt-1">
                        Real-time compliance rollup computed via LangGraph D3
                        evaluator &amp; D2 memory
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div className="bg-white rounded-xl border border-[#E2E8F0] p-6 relative overflow-hidden shadow-xs hover:shadow-md transition-shadow">
                    ...
                    <div className="flex justify-between items-start mb-3">
                        <span className="text-sm font-medium text-[#57605f]">
                            Total Clinicians
                        </span>
                ...
                <div className="bg-white rounded-xl border border-[#E2E8F0] p-6 relative overflow-hidden shadow-xs hover:shadow-md transition-shadow">
                    ...
                    <p className="text-xs text-[#57605f] mt-2">
                        Satisfying mandatory institutional policies
                    </p>
                </div>
                ...
                <div className="bg-white rounded-xl border border-[#E2E8F0] p-6 relative overflow-hidden shadow-xs hover:shadow-md transition-shadow">
                    ...
                    <p className="text-xs text-[#d97706] mt-2 font-medium">
                        Within 30-day renewal threshold
                    </p>
                </div>
                ...
                <div className="p-5 md:p-6 border-b border-[#E2E8F0] flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-[#f8f9ff]/50">
                    <div>
                        ...
                        <p className="text-xs text-[#57605f] mt-0.5">
                            Live database synchronization from D2 memory service
                        </p>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <div className="p-12 text-center text-[#57605f]">
                            ...
                            <p className="font-semibold text-[#0b1c30]">
                                No clinicians found matching criteria.
                            </p>
                            <p className="text-xs text-[#6f7976] mt-1">
                                Upload credential documents to begin tracking.
                            </p>
                        </div>
                    ) : (
                            ...
                            <tbody className="divide-y divide-[#E2E8F0] text-sm text-[#0b1c30]">
                                {filteredClinicians.map((clinician) => {
                                    const isNonCompliant =
                                        !clinician.summary.compliant;
                                    const isExpiring =
                                        (clinician.summary.counts_by_state
                                            ?.expiring_soon || 0) > 0;
                                    ...
                                    return (
                                        ...
                                        >
                                            <td className="py-4 px-5 font-medium">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-xs text-[#6f7976] font-mono">
                                                            ID:{" "}
                                                            {clinician.clinician_id.substring(
                                                                0,
                                                                8,
                                                            )}
                                                            ...
                                            ...
                                            <td className="py-4 px-5 text-[#57605f] capitalize">
                                                {clinician.role}
                                            </td>
                                            ...
                                            <td className="py-4 px-5 text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    <button
                                                        onClick={() =>
                                                            navigate(
                                                                `/clinicians?id=${clinician.clinician_id}`,
                                                            )
                                                        }
